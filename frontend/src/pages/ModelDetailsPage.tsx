      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="card p-6 mb-6">
          <div className="flex items-start justify-between mb-6">
            <div>
              <h2 className="text-lg font-semibold text-gray-900 mb-2">Model Information</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div>
              <p className="text-xs font-medium text-gray-500 uppercase tracking-wide mb-2">Model ID</p>
            ...
            <div>
              ...
              <p className="text-xl font-bold text-gray-900">{model.features.length}</p>
            </div>
            <div>
              <p className="text-xs font-medium text-gray-500 uppercase tracking-wide mb-2">Created</p>
              <p className="text-xl font-bold text-gray-900">
                {new Date(model.created_at).toLocaleDateString()}
              </p>
            </div>
            <div>
              <p className="text-xs font-medium text-gray-500 uppercase tracking-wide mb-2">Last Updated</p>
              <p className="text-xl font-bold text-gray-900">
        ...
        <div className="card p-6 mb-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Current Drift Status</h2>
          ...
          {currentDrift?.message ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div>
                <p className="text-xs font-medium text-gray-500 uppercase tracking-wide mb-2">Drift Score</p>
                <p className="text-2xl font-bold text-gray-900">
                  {currentDrift?.drift_score?.toFixed(3) || 'N/A'}
                </p>
              </div>
              <div>
                <p className="text-xs font-medium text-gray-500 uppercase tracking-wide mb-2">P-Value</p>
                <p className="text-2xl font-bold text-gray-900">
                  {currentDrift?.p_value?.toFixed(4) || 'N/A'}
                </p>
              </div>
              <div>
                <p className="text-xs font-medium text-gray-500 uppercase tracking-wide mb-2">Samples</p>
                <p className="text-2xl font-bold text-gray-900">
        ...
        {/* Features List */}
        <div className="card p-6 mb-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Model Features</h2>
            ...
            {model.features.map((feature) => (
              ...
              >
                ...
                {feature.baseline_stats ? (
                  <div className="mt-3">
                    <span className="badge-success text-xs">Baseline Configured</span>
        ...
        <div className="card p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <h3 className="font-semibold text-gray-900 group-hover:text-indigo-600">View Drift History</h3>
              <p className="text-sm text-gray-600 mt-1">See historical drift trends and charts</p>
            </button>
            ...
            >
              ...
              <h3 className="font-semibold text-gray-900 group-hover:text-green-600">Check Drift Now</h3>
              <p className="text-sm text-gray-600 mt-1">Run drift detection immediately</p>
            </button>
            ...
            >
              ...
              <h3 className="font-semibold text-gray-900 group-hover:text-purple-600">Back to Dashboard</h3>
